...
//		}
	...
	/**
	 * Tests the CompareTo
	 * Looks first at Name (Alphabetically)
	 * Then Looks at section numerically
	 */
	@Test
	public void testCompareTo(){
		Course c1 = new Course("AAA101", "Ruminations in A", "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c2 = new Course("BBB101", "Ruminations in B (prerequisite AAA101)", "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c3 = new Course("AAA101", "Ruminations in A", "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c4 = new Course("BBB101", "Ruminations in A", "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		assertTrue(c1.compareTo(c2) < 1);
		assertTrue(c1.compareTo(c3) < 1);
		assertTrue(c3.compareTo(c4) < 1);
		
	}
	
	/**
	 * Tests the getCourseRoll method to ensure that the roll field is getting set up properly
	 */
	@Test
