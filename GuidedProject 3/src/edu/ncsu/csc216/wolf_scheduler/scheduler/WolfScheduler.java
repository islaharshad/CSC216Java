...
public class WolfScheduler {
	 ...
	 * @throws IllegalArgumentException if course is already enrolled in or has a time
	 * overlap
     */
	 ...
	 * @throws IllegalArgumentException if event already enrolled or has a time conflict
	 */
	public void addEvent(String title, String meetingDays, int startTime, int endTime, int eventWeeklyRepeat, String eventDetails) throws IllegalArgumentException {
