...
public class WolfSchedulerTest {
	...
	public void testAddCourse() {
		...
		c1.setActivityTime(START_TIME, 1530);
		try {
			ws.addCourse("M", "001");
		}
		catch (IllegalArgumentException e) {
        ...
        c1.setActivityTime(END_TIME, 1600);
	...
	public void testAddEvent() {
		...
		e1.setActivityTime(EVENT_START_TIME, 1530);
		try {
			ws.addEvent(TITLE, MEETING_DAYS, START_TIME, 1530, EVENT_WEEKLY_REPEAT, EVENT_DETAILS);
		}
		catch (IllegalArgumentException e) {
		...
		try {
			...
			ws.addEvent("CSC316", MEETING_DAYS, 1200, 1400, EVENT_WEEKLY_REPEAT, EVENT_DETAILS);
		}
		catch (IllegalArgumentException e) {
			assertEquals("The event cannot be added due to a conflict.", e.getMessage());
		}
		...
		try {
			ws.addEvent("CSC316", MEETING_DAYS, 1445, 1600, EVENT_WEEKLY_REPEAT, EVENT_DETAILS);
		}
		catch (IllegalArgumentException e) {
			assertEquals("The event cannot be added due to a conflict.", e.getMessage());
		}
