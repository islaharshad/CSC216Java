...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		//Test invalid file
		try{
			sd.loadStudentsFromFile("notRealFile.txt");
			fail();
	...
	public void testAddStudent() {
		...
		try {
			sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, "wrongPassword", MAX_CREDITS);
			fail();
		} catch(IllegalArgumentException e) {
			assertEquals(e.getMessage(), "Passwords do not match");
		}
		
		//Test adding identical student
	...
	/**
	 * Tests StudentDirectory.getStudentDirectory
	 */
	@Test
	public void testGetStudentDirectory() {
		StudentDirectory sd = new StudentDirectory();
		sd.loadStudentsFromFile(validTestFile);
		String[][] compare = sd.getStudentDirectory();
		assertEquals("Demetrius", compare[0][0]);
	}
	...
	/**
	 * Tests the getStudentById method for existing and nonexistant students
	 */
	@Test
	public void testGetStudentById() {
		...
		Student z = new Student("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", hashPW, 15);
		Student a1 = sd.getStudentById("zking");
