...
public class StudentDirectory {
	 ...
	 * @return directory directory is a String array containing students first name, last name, and id.
	 */
	...
	/**
	 * This method returns the student by entering his/her id by the user.
	 * @param id Student unity Id.
	 * @return null if id doesn't match with the id of the student on file. 
	 */
