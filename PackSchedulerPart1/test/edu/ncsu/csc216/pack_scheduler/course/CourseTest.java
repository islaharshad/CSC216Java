...
import edu.ncsu.csc216.pack_scheduler.course.Course;
	...
	public class CourseTest {
		...
		public void testToString() {
			Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
			String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,30,MW,1330,1445";
			assertEquals(s1, c1.toString());
			
			Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, "A");
			String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,30,A";
		...
		public void testCompareTo() {
			...
			Course c3 = new Course("BIO116", TITLE, SECTION, CREDITS, INSTRUCTOR_ID,  ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
			Course c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
			Course c5 = new Course(NAME, TITLE, "000", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
			Course c6 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
			assertEquals(c1.compareTo(c2), -1);
		    assertEquals(c1.compareTo(c3), 1);
		    assertEquals(c1.compareTo(c4), -1);
		    assertEquals(c1.compareTo(c5), 1);
		    assertEquals(c1.compareTo(c6), 0);
		}
		
		/**
		 * Tests getShortDisplayArray method.
		 */
		@SuppressWarnings("deprecation")
		@Test
		public void testGetShortDisplayArray() {
		Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		String [] s = {"CSC216", "001", "Programming Concepts - Java" , "MW 1:30PM-2:45PM", "30"};
		assertEquals(s, c1.getShortDisplayArray());
		} 
	
		/**
		 * Tests getLongDisplayArray method.
		 */
		@SuppressWarnings("deprecation")
		@Test
		public void testGetLongDisplayArray() {
		Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		String [] s = {"CSC216", "001", "Programming Concepts - Java", "4", "sesmith5", "MW 1:30PM-2:45PM", "" };
		assertEquals(s, c1.getLongDisplayArray());
