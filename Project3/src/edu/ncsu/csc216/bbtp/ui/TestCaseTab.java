...
class TestCaseTab extends JPanel implements ActionListener, ListSelectionListener, DocumentListener, ChangeListener {
	 ...
	 * 
	 * @param testCaseList
	 *            TestCaseList for the current tab
	 * @param testingTypeList
	 *            TestingTypeList that will go in the EditPane
	 */
	 ...
	 * 
	 * @param e
	 *            DocuementEvent from the user typing in a field in the
	 *            TestCaseTab
	 */
	 ...
	 * 
	 * @param e
	 *            DocuementEvent from the user editing a field in TestCaseTab
	 */
	 ...
	 * 
	 * @param e
	 *            ListSelectionEvent of a user selecting a row in the table
	 */
