...
class TestingTypeListPane extends JScrollPane implements Observer {
	 ...
	 *            TestingTypeList of TestingType objects
	 */
	 ...
	 * object is changed. In this case, the observed object is the
	 * TestingTypeList. Any changes to the TestingTypeList will lead to an
	 * update of the TestingTypeTableModel.
	 * 
	 * @param o
