...
public class BBTPMenuBar extends JMenuBar {
	 ...
	 * 
	 * @param parent
	 *            the BBTPGUI that created the BBTPMenuBar
	 */
	 ...
	 * 
	 * @param menu
	 *            JMenu to add MenuItems to
	 * @param itemNames
	 *            name for the MenuItems
	 * @param hotkeys
	 *            keyboard shortcut for the MenuItems
	 * @param cmds
	 *            command strings for the MenuItems
	 */
