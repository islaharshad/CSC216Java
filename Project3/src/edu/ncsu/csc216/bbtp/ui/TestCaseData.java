...
public class TestCaseData {
	 ...
	 * @param testingType
	 *            test case's testing type
	 * @param creationDateTime
	 *            test case's creation date and time
	 * @param lastTestedDateTime
	 *            test case's last tested date and time
	 * @param testedStatusPass
	 *            test case's test status
	 * @param expectedResults
	 *            test case's expected result
	 * @param actualResults
	 *            test case's actual result from last testing
	 * @param pass
	 *            test case's pass status from last testing
	 */
